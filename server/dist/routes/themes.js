...
exports.themesRouter.post("/generate", auth_js_1.requireAuth, async (req, res) => {
    try {
        ...
        const { files, manifest } = await (0, copilotThemeService_js_1.generateThemeWithAdapters)(parsed.platform, parsed.niche, parsed.goal);
        // Upload ZIP
        ...
        const validatedRecord = shared_1.ThemeGenerateResponseSchema.parse(record);
